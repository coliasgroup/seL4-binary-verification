...
deriving via (JSONBVFile (FlattenedProofChecks String)) instance ReadBVFile BL.ByteString (FlattenedProofChecks String)
deriving via (JSONBVFile (FlattenedProofChecks String)) instance WriteBVFile BL.ByteString (FlattenedProofChecks String)

deriving via (JSONBVFile (FlattenedSMTProofChecks ())) instance ReadBVFile BL.ByteString (FlattenedSMTProofChecks ())
deriving via (JSONBVFile (FlattenedSMTProofChecks ())) instance WriteBVFile BL.ByteString (FlattenedSMTProofChecks ())
